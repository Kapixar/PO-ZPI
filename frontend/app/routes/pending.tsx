...
export default function Dashboard() {
    ...
    const [selectedTopic, setSelectedTopic] = useState<PendingTopic | null>(
        null,
    );
    ...
    const selectedTopicsList = standardTopics.filter((t) =>
        selectedStandardIds.has(t.id),
    );
        ...
        <div>
                            ...
                            {standardTopics.map((topic) => (
                                <li key={topic.id}>
                                    <label className="checkbox">
                                        <input
                                            type="checkbox"
                                            checked={selectedStandardIds.has(
                                                topic.id,
                                            )}
                                            onChange={() =>
                    ...
                    {showApproveSuccess ? (
                        <dialog className="active medium-width modal">
                            ...
                            <nav className="center-align padding">
                                <button
                                    className="transparent red-text"
                                    onClick={handleCloseSuccessAndRefresh}
                                >
                                    OK
                                </button>
                            </nav>
                    ...
                    isRejecting ? (
                        <dialog className="active medium modal center-align rounded-2xl">
                            <div className="padding">
                                ...
                                <div className="space"></div>
                                <div
                                    className={`field textarea border fill round ${rejectionError ? "invalid" : ""}`}
                                >
                                    <textarea
                                    ...
                                    {rejectionError && (
                                        <span className="error red-text">
                                            Uzasadnienie nie powinno być puste!
                                        </span>
                                    )}
                                </div>
                            </div>
                        ...
                        <dialog className="active medium-width modal">
                            <header className="fixed">
                                <nav>
                                    ...
                                    <h5 className="max">
                                        {selectedTopic.student_count === 4
                                            ? "Zatwierdź temat"
                                            : "Zatwierdź temat niestandardowy"}
                                    </h5>
                                    <button className="circle transparent">
                                        <i>more_vert</i>
                                    </button>
                            ...
                            <div className="padding">
                                ...
                                <div className="field">
                                    <label className="bold">
                                        Wnioskujący prowadzący
                                    </label>
                                    <div>
                                        {selectedTopic.teacher_title}{" "}
                                        {selectedTopic.teacher_full_name}
                                    </div>
                                </div>
                                <div className="space"></div>
                                <div className="field">
                                ...
                                {selectedTopic.student_count !== 4 && (
                                    <>
                                        ...
                                        <div className="field">
                                            <label className="bold">
                                                Uzasadnienie niestandardowego
                                                rozmiaru
                                            </label>
                                            <p className="small-text">
                                                {
                                                    selectedTopic.topic_justification
                                                }
                                            </p>
                                        </div>
                                    </>
                            ...
                            <nav className="right-align padding">
                                <button
                                    className="transparent border-error red-text"
                ...
                <>
                    ...
                    <dialog className="active medium modal center-align rounded-2xl">
                        <div className="padding">
                            ...
                            <div className="space"></div>
                            <h5>
                                Czy chcesz potwierdzić zaznaczone{" "}
                                {selectedStandardIds.size} tematy?
                            </h5>
                            <div className="space"></div>
            ...
            {showBulkApproveSuccess && (
                <>
                    <div
                        className="overlay blur active"
                        onClick={handleCloseBulkSuccess}
                    ></div>
                    <dialog className="active medium modal center-align rounded-2xl">
                        <div className="padding">
                            <i className="extra">fact_check</i>
                            <div className="space"></div>
                            <h5>
                                Zatwierdzono {selectedTopicsList.length} tematy
                            </h5>
                            <div className="space"></div>
